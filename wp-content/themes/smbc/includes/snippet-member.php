<div class="member">
  <div class="member__picture-outer">
    <a href="#" class="member__picture ratio-box ratio--1-1">
  ...
  <div class="member__details">
    ...
    <p class="type-tiny type-lightblue">Crema Construction</p>
    <div class="member__btns">
      <a class="member__btn member__btn--www" href="https://google.com.au"></a>
      <a class="member__btn member__btn--li" href="https://linkedin.com"></a>
      <button class="member__btn member__btn--mic" data-audio=""></button>
    </div>
  </div>
